...
public class StellentAccountReconTaskDemo
{
    public static void main(String[] args)
    {
        ...
        //task.setUrl("https://contribute.ccci.org/ucmcont/idcplg?IdcService=QUERY_DOC_ACCOUNTS&IsSoap=1");
        task.setUrl("http://ucm-contribution-n1.ccci.org/ucmcont/idcplg?IdcService=QUERY_DOC_ACCOUNTS&IsSoap=1");
